...
class ALOV300ModelBase(object):
    ...
    def _conv2d(self, x, kernel_size, filters, strides, name, padding='same', act=tf.nn.relu, batch_norm=True):
        with tf.variable_scope(name):
            ...
            tf.summary.image('%s_feature_maps_l2_norm' % name, tf.norm(conv, axis=3, ord=2), max_outputs=64)
